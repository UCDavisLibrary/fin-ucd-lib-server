...
export default class AppFsViewer extends Mixin(LitElement)
  ...
  _getFullFileUrl(file) {
    ...
    // return 'https://sandbox.dams.library.ucdavis.edu/fcrepo/rest' + file['@id'];  // dev local, point to sandbox collections
    // return 'https://digital.ucdavis.edu/fcrepo/rest' + file['@id'];
  }
