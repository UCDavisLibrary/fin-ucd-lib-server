...
import { RenderingCancelledException } from './display_utils';
...
class PDFThumbnailView {
  ...
  get _thumbPageTitle() {
    return 'Page ' + (!this.pageLabel ? this.id : this.pageLabel);
  }

  get _thumbPageCanvas() {
    return 'Thumbnail of Page ' + (!this.pageLabel ? this.id : this.pageLabel);
  }
