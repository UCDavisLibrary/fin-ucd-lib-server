...
class PDFPageView {
  ...
  constructor(options) {
    ...
    //   options.textHighlighterFactory ? options.textHighlighterFactory.createTextHighlighter({
    //     pageIndex: this.id - 1,
  ...
  async _renderXfaLayer() {
    ...
    try {
      ...
      if (result && result.textDivs && this.textHighlighter) {
  ...
  reset({
    ...
    const childNodes = div.childNodes,
      ...
      annotationLayerNode =
        (keepAnnotationLayer && this.annotationLayer && this.annotationLayer.div) || null,
      annotationEditorLayerNode =
        (keepAnnotationEditorLayer && this.annotationEditorLayer && this.annotationEditorLayer.div) || null,
      xfaLayerNode = (keepXfaLayer && this.xfaLayer && this.xfaLayer.div) || null;
    ...
    } else if (this.annotationEditorLayer) {
  ...
  draw() {
    ...
    let lastDivBeforeTextDiv;
    if (this.annotationLayer) {
      lastDivBeforeTextDiv = this.annotationLayer.div;
    } else if (this.annotationEditorLayer) {
      lastDivBeforeTextDiv = this.annotationEditorLayer.div;
    }
    ...
    if (this.xfaLayer && this.xfaLayer.div) {
