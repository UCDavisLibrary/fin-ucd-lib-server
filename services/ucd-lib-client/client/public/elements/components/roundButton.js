...
import render from './roundButton.tpl.js';
import "./icon";

/**
 * @class AppRoundButton
 * @description Styleized UI component for dropdown button. Wrapper around polymer's options.
 */
export class AppRoundButton extends LitElement {
...
customElements.define('app-round-button', AppRoundButton);
