...
`}i(141);var D=i(184),B=i.n(D),U=i(24),E=i.n(U);class O extends(Mixin(n.a).with(EventInterface,E.a,v.a)){static get template(){let e=document.createElement("template");return e.innerHTML=B.a,e}static get properties(){return{record:{type:Object,value:()=>{}},media:{type:Object,value:()=>{}},loading:{type:Boolean,value:!1},height:{type:Number,value:600},hasMultipleImages:{type:Boolean,value:!1}}}constructor(){super(),this.active=!0}async ready(){super.ready();let e=await this.AppStateModel.getSelectedRecordMedia();e&&this._onSelectedRecordMediaUpdate(e)}_onSelectedRecordMediaUpdate(e){if(!e)return;let t=c.a.getMediaType(e);"ImageList"!==t&&"ImageObject"!==t||(this.media=e,this._renderImg())}_renderImg(){this.media.hasPart&&this.media.hasPart.length>0&&(this.media.image=this.media.hasPart[0].image),this.media.image.width<this.height&&(this.height=this.media.image.width);let e=this._getImgUrl(this.media.image.url,"",this.height),t=600/this.media.image.height,i=this.media.image.width*t,n=this.offsetWidth-20;n<1&&(n=1);let o=Math.ceil(n>i?this.height:n/i*this.height),a=new Image;this.loading=!0,this.$.loading.style.height=o+"px",a.onload=()=>{this.loading=!1,this.$.img.style.height="auto"},a.src=e,this.$.img.style.maxWidth=i+"px",this.$.img.src=e}}customElements.define("app-image-viewer",O);var H=i(185),j=i.n(H);class V extends(Mixin(n.a).with(EventInterface,E.a,v.a)){static get template(){let e=document.createElement("template");return e.innerHTML=j.a,e}static get properties(){return{record:{type:Object,value:()=>{}},media:{type:Object,value:()=>{}},mediaUrl:{type:String,value:""},loading:{type:Boolean,value:!1},height:{type:Number,value:600}}}constructor(){super(),this.active=!0}async ready(){super.ready();let e=await this.AppStateModel.getSelectedRecordMedia();e&&this._onSelectedRecordMediaUpdate(e)}_onSelectedRecordMediaUpdate(e){if(!e)return;let t=c.a.getMediaType(e);"ImageList"!==t&&"ImageObject"!==t||(this.media=e,this.mediaUrl="https://sandbox.dams.library.ucdavis.edu/fcrepo/rest"+this.media["@id"])}_renderPdfRetry(){}_renderPdf(){}_cleanup(){}bindEvents(){}unbindEvents(){}}customElements.define("app-pdf-viewer",V);var N=i(186);function Z(){return k.b`
    <style>
        :host {
            display: block;
            /* padding-bottom: 8px; */
    ...
    <div class="container">
        ...
        <video ?hidden="${!this.libsLoaded}" id="video" playsinline controls crossorigin>
            ${Object(N.a)(this.tracks,e=>k.b`<track kind="${e.kind}" label="${e.label}" src="${e.src}" srclang="${e.srclang}" default="${e.default}" />`)}
        </video>
        <div id="loading" ?hidden="${this.libsLoaded}">
            <paper-spinner-lite ?active="${!this.libsLoaded}"></paper-spinner-lite>
        </div>
    </div>
`}i(12);var W=new class{async load(){return this.loaded?this.loaded:this.loading?(await this.loading,this.loaded):(this.loading=new Promise(async(e,t)=>{const n=(await i.e(11).then(i.t.bind(null,208,7))).default,o=await i.e(11).then(i.t.bind(null,209,7));await o.polyfill.installAll(),this.loaded={plyr:n,shaka:o},e(this.loaded)}),this.loading)}},q=i(149),X=i.n(q),K=i(157),G=i.n(K),J=i(158),Y=i.n(J);let Q=X.a+G.a,ee=Y.a;class te{constructor(e){}remove(){return!0}destroy(){}append(e){}setTextVisibility(e){}isTextVisible(){return!1}}class ie extends(Mixin(k.a).with(LitCorkUtils)){static get properties(){return{player:{type:Object},tracks:{type:Array},libsLoaded:{type:Boolean}}}constructor(){super(),this.render=Z.bind(this),this._injectModel("AppStateModel","MediaModel"),this.tracks=[],this.player={},this.libsLoaded=!1}_onAppStateUpdate(e){this.fullPath!==e.location.fullpath&&this._stop(),this.fullPath=e.location.fullpath}async firstUpdated(e){let t=await this.AppStateModel.getSelectedRecordMedia();t&&this._onSelectedRecordMediaUpdate(t),this.fullPath=(await this.AppStateModel.get()).location.fullpath,ee.indexOf("data:image/svg+xml;base64")>-1&&(ee=atob(ee.replace("data:image/svg+xml;base64,",""))),this.shadowRoot.querySelector("#sprite-plyr").innerHTML=ee;let i=document.createElement("style");i.innerHTML=Q,window.ShadyDOM&&window.ShadyDOM.inUse?(document.head.appendChild(i),this.hideControls=!1):(this.shadowRoot.appendChild(i),this.hideControls=!0)}async _onSelectedRecordMediaUpdate(e){if(!e)return;let t=c.a.getMediaType(e);if("VideoObject"!==t&&"StreamingVideo"!==t)return;if(this.media=e,this.tracks=c.a.asArray(e,"caption").filter(e=>void 0!==e["@id"]).map(e=>{let t=e.language,i="en"===t;return{kind:"captions",label:c.a.getLanguage(t),srclang:t,src:e["@id"],default:i}}),this.libsLoaded)return void this._loadVideo();let{plyr:i,shaka:n}=await W.load(),o=i.supported("video","html5",!0),a=n.Player.isBrowserSupported();if(!o||!a)return alert("Your browser does not support video playback");let r=this.shadowRoot.getElementById("video");this.plyr=new i(r,{hideControls:this.hideControls,fullscreen:{enabled:!1},captions:{update:!1},controls:["play-large","play","progress","current-time","mute","volume"]}),this.shaka=new n.Player(r),this.shaka.configure({textDisplayFactory:te}),this.shaka.addEventListener("error",e=>console.error("shaka error",e)),this.libsLoaded=!0,await this._loadVideo()}async _loadVideo(){if(!this.media)return;let e=c.a.getMediaType(this.media),t=b.a.fcrepoBasePath+this.media["@id"];"StreamingVideo"===e&&(t+="/playlist.m3u8");try{await this.shaka.load(t)}catch(e){console.error("Error code: ",e.code,"object",e)}}_stop(){this.shadowRoot.querySelector("#video").pause(),void 0!==this.plyr&&null!==this.plyr&&0!=Object.entries(this.plyr).length&&this.plyr.stop()}}function ne(){return k.b`
<style>
  :host {
    display: none;
    padding: 20px;
